...
<div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
    ...
    <a href="/welcome-1">Go To Welcome</a>
    <br>
    <!-- a bit secured -->
    <a href="{{ url('welcome-2') }}">Using url</a>
    <br>
    <!-- most secured -->
    <a href="{{ route('email') }}">Using route</a>
    <br>
    <a href="{{ route('welcome3',[ 'var3'=> 4, 'a'=> 5,]) }}">Passing variable from route</a>
